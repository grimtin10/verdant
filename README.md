...
```toml
[dependencies]
verdant = { version = "0.8", default-features = false, features = ["vulkan", "dx12", "metal"] }
```
...
```toml
[dependencies]
verdant = { version = "0.8", default-features = false, features = ["vulkan", "dx12", "metal", "gles"] }
```
...
```toml
[dependencies]
verdant = { version = "0.8", default-features = false, features = ["vulkan", "dx12", "metal", "image-png", "image-jpeg", "image-webp"] }
```
